...
- **Dual-model architecture:** a multi-model ensemble for active customers, and a separately tuned XGBoost model for retired customers, since these are two populations with different churn drivers.
